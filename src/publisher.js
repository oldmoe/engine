...
NE.Publisher = {
    ...
    subscribe : function(event, subscriber, method){
        ...
        if(subscriber.onsubscribe){subscriber.onsubscribe(this)}
        return this;
    },
	
    fire : function(event, options, result){
        ...
        while(this.subscriptions[event].length > 0){
            ...
            if(object[method](options, result) === false){
            }else{
